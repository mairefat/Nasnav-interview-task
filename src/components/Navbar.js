...
const Navbar = () => {
  return (
    <div>
    <nav className=" bg-[#fff100] py-2 relative top-0 w-full h-full bg-primary-color shadow-md flex items-center justify-center ">
      <div className="container h-100  ">
        <div className="flex items-center px-32 ">
          ...
          <div className="flex px-8  text-black items-center space-x-4 pr-4">
            <Link to="#" className="">
              <FontAwesomeIcon icon={faEnvelope} /> Contact Us
            </Link>
            <Link to="#" className="">
              <FontAwesomeIcon icon={faShippingFast} /> Track Order
            </Link>
            <Link to="#" className="">
              <FontAwesomeIcon icon={faStore} /> Find A Store
            </Link>
          </div>
